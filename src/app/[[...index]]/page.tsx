      ...
      <div className="hidden lg:block w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute w-full text-center bottom-[50%] text-[46px] font-unagiiiiiii text-dark/50 leading-none"
            style={{ 
        ...
        <motion.div 
            ...
            className="absolute w-full text-center top-[37%] z-20 text-[64px] font-unagiiiiiii text-white leading-none"
            style={{ 
        ...
        <motion.div 
          ...
          className="absolute w-full text-center gradient-glow top-[49%] z-20 text-[90px] font-unagii text-dark/90 leading-none"
        >
          Wing(Wo)man
        </motion.div>
      </div>
